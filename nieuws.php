...
<body>
  ...
  <div class="log container">
    <h3 style="margin-top:20px;color:#48c16a;">Nieuws</h3>
    <hr style="background-color:#48c16a;margin-top:-15px;">
    <p style="font-family:Calibri;">Lintstage klas 4 is van donderdag 6 september 2018 t/m donderdag 28<br> maart 2019. Dit kan worden verdeeld in twee periodes van 2 keer 12<br> weken.</p>
  </div>
  <script>
