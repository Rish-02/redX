...
<body>
  ...
  <div class="log container">
    <h3 style="margin-top:20px;color:#48c16a;">Ervaringen</h3>
    <hr style="background-color:#48c16a;margin-top:-15px;">
    <p style="font-family:Calibri;">Binnenkort leest u hier meer over de ervaringen van onze talenten en professionals</p>
  </div>
  <script>
