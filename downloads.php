...
<body>
  ...
  <div class="log container">
    <h3 style="margin-top:20px;color:#48c16a;">Downloads</h3>
    <hr style="background-color:#48c16a;margin-top:-15px;">
    <p style="font-family:Calibri;">Hieronder treft u algemene downloads die voor iedereen beschikbaar zijn. Log in onder u eigen account (talent, begeleider of professional) om de voor u specifieke downloads te bekijken.</p>
  </div>
  <script>
